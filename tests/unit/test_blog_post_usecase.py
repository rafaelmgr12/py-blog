...
class TestBlogPostUseCase(unittest.TestCase):
    def setUp(self):
        ...
        self.blog_post_usecase = BlogPostUseCase(
            self.blog_post_repository, self.user_repository
        )
    ...
    def test_delete_blog_post_not_authorized(self):
        ...
        self.blog_post_repository.get_blog_post_by_id.return_value = BlogPost(
            "Test Title", "Test Content", uuid.UUID(other_user_id)
        )
    ...
    def test_delete_blog_post_success(self):
        ...
        self.blog_post_repository.get_blog_post_by_id.return_value = BlogPost(
            "Test Title", "Test Content", uuid.UUID(user_id)
        )
